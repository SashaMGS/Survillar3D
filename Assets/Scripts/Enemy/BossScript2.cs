...
public class BossScript2 : MonoBehaviour
{
    ...
    public GameObject babyEnemyPack;
    public GameObject traceParticle;
    public GameObject shootingMob1;
    public GameObject shootingMob2;
    ...
    public void hpBoss()
    {
        if (hp <= 0 && !isDie)
        {
            ...
            saveAll.saveItemsClass.countKillBoss3++;
            ...
            saveAll.saveItemsClass.KillBossRand3 = true;
            Destroy(babyEnemyPack);
            GetComponent<NavMeshAgent>().enabled = false;
            shootingMob1.GetComponent<ShootingMob>().isCanShoot = false;
            shootingMob2.GetComponent<ShootingMob>().isCanShoot = false;
            shootingMob1.GetComponent<RotationOnObject>().enabled = false;
            shootingMob2.GetComponent<RotationOnObject>().enabled = false;
